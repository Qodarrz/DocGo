...
export default function DoctorSidebar() {
  ...
  const links: SidebarLinkProps[] = [
    { label: "Dashboard", href: "/doctor", icon: <IconDashboard className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" /> },
    { label: "Consultation", href: "/doctor/consultation", icon: <IconStethoscope className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" /> },
  ];
...
const Logo = ({ open }: { open: boolean }) => (
  <Link href="/doctor" className="flex items-center space-x-2 py-1 text-sm font-normal text-black">
